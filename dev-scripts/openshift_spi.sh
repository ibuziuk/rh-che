...
curl -sSL https://gist.githubusercontent.com/garagatyi/49c1eeaa26ee9ff3b2c3aca55243556f/raw/ba93b117199212fd8be195764136aa23c361afe6/che-spi-openshift.yml | \
    ...
    sed "s|    CHE_INFRA_OPENSHIFT_CHE__SERVER__ENDPOINT:.*|    CHE_INFRA_OPENSHIFT_CHE__SERVER__ENDPOINT: http://che-${DEFAULT_OPENSHIFT_NAMESPACE_URL}/wsmaster/api|" | \
    ...
    sed "s|    CHE_WEBSOCKET_ENDPOINT_BASE:.*|    CHE_WEBSOCKET_ENDPOINT_BASE: ws://che-${DEFAULT_OPENSHIFT_NAMESPACE_URL}|" | \
    sed "s|    CHE_INFRA_OPENSHIFT_CHE__SERVER__WEBSOCKET__ENDPOINT__BASE:.*|    CHE_INFRA_OPENSHIFT_CHE__SERVER__WEBSOCKET__ENDPOINT__BASE: ws://che-${DEFAULT_OPENSHIFT_NAMESPACE_URL}/wsmaster|" | \
...
echo "[CHE]    http://${che_route}/dashboard"
